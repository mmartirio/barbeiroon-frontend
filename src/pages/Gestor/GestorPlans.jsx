...
const FEATURES = [
  ...
  { key: 'financeiro_resumo',     label: 'financeiro.resumo' },
  { key: 'financeiro_receitas',   label: 'financeiro.receitas' },
  { key: 'financeiro_despesas',   label: 'financeiro.despesas' },
  { key: 'financeiro_comissao',   label: 'financeiro.comissao' },
  { key: 'financeiro_fluxo',      label: 'financeiro.fluxo' },
  { key: 'financeiro_ranking',    label: 'financeiro.ranking' },
  { key: 'financeiro_produtos',   label: 'financeiro.produtos' },
